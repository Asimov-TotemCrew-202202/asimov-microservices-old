package com.totemcrew.courseservice.courses.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Event<?>> consumerFactory() {
        ...
        props.put(
                ...
                bootstrapAddress);
        props.put(JsonSerializer.TYPE_MAPPINGS,"com.totemcrew.courseservice.courses:com.totemcrew.courseservice.courses.events.Event");
